...
export function AuthPage({ mode }: { mode: "login" | "register" }) {
  ...
  return (
    <main className="grid min-h-screen bg-slate-50 lg:grid-cols-[1fr_460px]">
      <section className="hidden min-h-screen flex-col justify-between border-r border-slate-200 bg-white p-10 lg:flex">
        <div>
          <div className="text-sm font-semibold uppercase tracking-wide text-cyan-700">Project Mesh</div>
        ...
        <div className="grid max-w-2xl gap-3 text-sm text-slate-600">
      ...
      <section className="flex min-h-screen items-center justify-center px-4 py-10">
        <Panel className="w-full max-w-md p-6 shadow-sm">
          <div className="mb-6">
            <div className="text-sm font-semibold text-cyan-700">Project Mesh</div>
          ...
          <div className="mt-5 text-center text-sm text-slate-500">
            {mode === "login" ? (
              ...
              <>
                Already registered?{" "}
                <Link className="font-medium text-cyan-700 hover:text-cyan-900" to="/login">
                  Sign in
                </Link>
              </>
            )}
