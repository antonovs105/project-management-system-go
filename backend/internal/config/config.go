...
// EnvironmentVariables lists every legacy environment override accepted by Load.
// Operators should prefer the typed YAML file for new installations; Compose uses
// this list as a compatibility contract.
func EnvironmentVariables() []string {
	return []string{
		"APP_ENV", "APP_ROLE",
		"DB_SOURCE", "DB_MAX_OPEN_CONNECTIONS", "DB_MAX_IDLE_CONNECTIONS",
		"DB_CONN_MAX_LIFETIME_SECONDS", "DB_CONN_MAX_IDLE_TIME_SECONDS",
		"JWT_SECRET_KEY", "ACTOR_PRIVATE_KEY_ENCRYPTION_KEY", "ACTOR_PRIVATE_KEY_PREVIOUS_ENCRYPTION_KEYS",
		"PUBLIC_BASE_URL", "LOCAL_DOMAIN", "INSTANCE_NAME",
		"REDIS_ADDR", "METRICS_ADDR", "METRICS_TOKEN",
		...
		"SMTP_HOST", "SMTP_PORT", "SMTP_USERNAME", "SMTP_PASSWORD", "SMTP_FROM_ADDRESS", "SMTP_FROM_NAME", "SMTP_IMPLICIT_TLS",
		"ATTACHMENTS_ENABLED", "ATTACHMENTS_STORAGE_PATH", "CLAMAV_ADDR",
		"GITHUB_API_TOKEN", "GITHUB_WEBHOOK_SECRET",
		"PROJECT_CREATION_POLICY", "REGISTRATION_ENABLED",
		"FEDERATION_BLOCKED_DOMAINS", "FEDERATION_ALLOW_INSECURE_HTTP", "FEDERATION_ALLOW_PRIVATE_NETWORKS",
		"CORS_ALLOWED_ORIGINS", "TRUSTED_PROXY_CIDRS",
		"AUTH_RATE_LIMIT_PER_SECOND", "AUTH_RATE_LIMIT_BURST",
		"DISCOVERY_RATE_LIMIT_PER_SECOND", "DISCOVERY_RATE_LIMIT_BURST",
		"INBOX_RATE_LIMIT_PER_SECOND", "INBOX_RATE_LIMIT_BURST",
	}
}
