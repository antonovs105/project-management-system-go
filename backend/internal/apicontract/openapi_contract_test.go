...
func TestOpenAPIContractDocumentsRegisteredRoutes(t *testing.T) {
	...
	for _, route := range []struct {
		...
		{method: "get", path: "/api/v1/me/notifications/events"},
		{method: "patch", path: "/api/v1/me/notifications/{id}/read"},
		{method: "post", path: "/api/v1/me/notifications/read-all"},
		{method: "get", path: "/api/v1/me/notification-preferences"},
		{method: "put", path: "/api/v1/me/notification-preferences/{type}"},
		...
		{method: "get", path: "/api/v1/me/mfa"},
		{method: "delete", path: "/api/v1/me/mfa"},
		{method: "post", path: "/api/v1/me/mfa/setup"},
		{method: "post", path: "/api/v1/me/mfa/confirm"},
		...
		{method: "get", path: "/api/v1/projects/archived"},
		...
		{method: "get", path: "/api/v1/projects/{projectID}/activity"},
		{method: "post", path: "/api/v1/projects/{projectID}/archive"},
		{method: "post", path: "/api/v1/projects/{projectID}/restore"},
		...
		{method: "get", path: "/api/v1/projects/{projectID}/tickets/archived"},
		...
		{method: "get", path: "/api/v1/tickets/{ticketID}/attachments"},
		{method: "post", path: "/api/v1/tickets/{ticketID}/attachments"},
		{method: "get", path: "/api/v1/attachments/{attachmentID}/content"},
		{method: "delete", path: "/api/v1/attachments/{attachmentID}"},
		{method: "post", path: "/api/v1/tickets/{ticketID}/move"},
		{method: "post", path: "/api/v1/tickets/{ticketID}/archive"},
		{method: "post", path: "/api/v1/tickets/{ticketID}/restore"},
